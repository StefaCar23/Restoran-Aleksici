<head>
	...
	<body>
		<div id="wraper">
			...
			<div id="content">
			<?php
			echo "<p> Adresa: Požeška 123a, sprat 2 <br /> <br /> Telefon: 011/354-88-52 <br /> <br /> E-mail: kontakt@stefanaleksic.rs <br /> <br />
			<a href='http://bit.ly/2AbxNOl'> Pronađite nas na mapi! </a>
		</p>";
			?>
